...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi SpecialKey ctermfg=102 ctermbg=NONE cterm=NONE guifg=#404040
    ...
    hi Function ctermfg=142 ctermbg=NONE cterm=bold guifg=#fabd2f gui=NONE
    ...
    hi Type ctermfg=214 ctermbg=NONE cterm=NONE guifg=#83a598 gui=NONE
    ...
    if get(g:, "gruvbox_filetype_hi_groups", 1)
      ...
      hi cOperator ctermfg=175 ctermbg=NONE cterm=NONE guifg=#83a598 gui=none
